...
var TextAreaWithSaveCancel = function (_a) {
    ...
    return (React.createElement("div", { style: { marginTop: 10 } },
        React.createElement(TextArea$1, { value: value, onChange: handleChange, rows: 4, placeholder: "Type something...", style: { width: "100%" } }),
...
var RefIcon$5 = /*#__PURE__*/React__namespace.forwardRef(ArrowDownOutlined);
...
var RefIcon$4 = /*#__PURE__*/React__namespace.forwardRef(ArrowUpOutlined);
if (process.env.NODE_ENV !== 'production') {
...
var RefIcon$3 = /*#__PURE__*/React__namespace.forwardRef(DeleteOutlined);
if (process.env.NODE_ENV !== 'production') {
...
var RefIcon$2 = /*#__PURE__*/React__namespace.forwardRef(EditOutlined);
if (process.env.NODE_ENV !== 'production') {
...
var RefIcon$1 = /*#__PURE__*/React__namespace.forwardRef(EyeOutlined);
if (process.env.NODE_ENV !== 'production') {
...
var RefIcon = /*#__PURE__*/React__namespace.forwardRef(PlusOutlined);
if (process.env.NODE_ENV !== 'production') {
...
var FormGenerator = function (_a) {
    ...
    var _f = React.useState(getInitialField()), currentField = _f[0], setCurrentField = _f[1];
    ...
    var handleAddField = function () {
        form.validateFields().then(function (values) {
            var newField = tslib.__assign(tslib.__assign({}, currentField), values);
            if (isEditing) {
                ...
                updateFields(tslib.__spreadArray(tslib.__spreadArray([], fields, true), [newField], false));
            }
    ...
    var handleMoveUp = function (index) {
        ...
        if (index === 0)
            return;
        var newFields = tslib.__spreadArray([], fields, true);
    ...
    var handleOptionChange = function (options) {
        setCurrentField(tslib.__assign(tslib.__assign({}, currentField), { options: options }));
    };
    // Add a new option
    var handleAddOption = function () {
        var options = tslib.__spreadArray(tslib.__spreadArray([], currentField.options, true), ["Option ".concat(currentField.options.length + 1)], false);
    ...
    var handleOptionTextChange = function (index, value) {
        var options = tslib.__spreadArray([], currentField.options, true);
        options[index] = value;
        handleOptionChange(options);
    };
    ...
    var renderFieldModal = function () { return (React.createElement(antd.Modal, { title: isEditing ? "Edit Field" : "Add Field", open: isModalVisible, onOk: handleAddField, onCancel: function () {
            setIsModalVisible(false);
            setCurrentField(getInitialField());
            form.resetFields();
            setIsEditing(false);
        }, width: 700 },
        React.createElement(antd.Form, { form: form, layout: "vertical", initialValues: currentField },
            React.createElement(antd.Row, { gutter: 16 },
                React.createElement(antd.Col, { span: 12 },
                    React.createElement(antd.Form.Item, { name: "type", label: "Field Type", rules: [{ required: true, message: 'Please select a field type' }] },
                        React.createElement(antd.Select, { onChange: function (value) { return setCurrentField(tslib.__assign(tslib.__assign({}, currentField), { type: value })); } },
                            React.createElement(Option, { value: FIELD_TYPES.INPUT }, "Text Input"),
                            React.createElement(Option, { value: FIELD_TYPES.TEXTAREA }, "Text Area"),
                            React.createElement(Option, { value: FIELD_TYPES.CHECKBOX }, "Multiple Choice (Checkbox)"),
                            React.createElement(Option, { value: FIELD_TYPES.RADIO }, "Radio Buttons"),
                            React.createElement(Option, { value: FIELD_TYPES.NUMBER }, "Number"),
                            React.createElement(Option, { value: FIELD_TYPES.SELECT }, "Dropdown Select")))),
                React.createElement(antd.Col, { span: 12 },
                    React.createElement(antd.Form.Item, { name: "label", label: "Field Label", rules: [{ required: true, message: 'Please enter a label' }] },
                        React.createElement(antd.Input, { placeholder: "Enter field label" })))),
            React.createElement(antd.Form.Item, { name: "placeholder", label: "Placeholder" },
                React.createElement(antd.Input, { placeholder: "Enter placeholder text" })),
            React.createElement(antd.Form.Item, { name: "instructions", label: "Instructions" },
                React.createElement(antd.Input, { placeholder: "Enter instructions for this field" })),
            React.createElement(antd.Form.Item, { name: "required", valuePropName: "checked" },
                React.createElement(antd.Switch, { checkedChildren: "Required", unCheckedChildren: "Optional" })),
            (currentField.type === FIELD_TYPES.NUMBER) && (React.createElement(antd.Row, { gutter: 16 },
                React.createElement(antd.Col, { span: 12 },
                    React.createElement(antd.Form.Item, { name: "minValue", label: "Minimum Value" },
                        React.createElement(antd.InputNumber, null))),
                React.createElement(antd.Col, { span: 12 },
                    React.createElement(antd.Form.Item, { name: "maxValue", label: "Maximum Value" },
                        React.createElement(antd.InputNumber, null))))),
            (currentField.type === FIELD_TYPES.CHECKBOX ||
                currentField.type === FIELD_TYPES.RADIO ||
                currentField.type === FIELD_TYPES.SELECT) && (React.createElement("div", null,
                React.createElement("div", { className: "options-header", style: { display: 'flex', justifyContent: 'space-between', marginBottom: '10px' } },
                    React.createElement("h4", null, "Options"),
                    React.createElement(antd.Button, { type: "dashed", onClick: handleAddOption, icon: React.createElement(RefIcon, null) }, "Add Option")),
                currentField.options.map(function (option, index) { return (React.createElement("div", { key: index, style: { display: 'flex', marginBottom: '8px' } },
    ...
    return (React.createElement("div", null,
        ...
        fields.length > 0 ? (React.createElement("div", null, fields.map(function (field, index) { return (React.createElement(antd.Card, { key: field.id, style: { marginBottom: 16 }, title: "".concat(index + 1, ". ").concat(field.label, " (").concat(field.type, ")"), extra: React.createElement(antd.Space, null,
                ...
                React.createElement(antd.Tooltip, { title: "Move Down" },
                    React.createElement(antd.Button, { icon: React.createElement(RefIcon$5, null), disabled: index === fields.length - 1, onClick: function () { return handleMoveDown(index); } })),
                React.createElement(antd.Tooltip, { title: "Edit" },
                    React.createElement(antd.Button, { icon: React.createElement(RefIcon$2, null), onClick: function () { return handleEditField(field); } })),
                React.createElement(antd.Tooltip, { title: "Delete" },
                    React.createElement(antd.Button, { danger: true, icon: React.createElement(RefIcon$3, null), onClick: function () { return handleDeleteField(field.id); } }))) },
            React.createElement("p", null,
                React.createElement("strong", null, "Type:"),
                " ",
                field.type),
            field.placeholder && React.createElement("p", null,
                React.createElement("strong", null, "Placeholder:"),
                " ",
                field.placeholder),
            field.instructions && React.createElement("p", null,
            ...
            (field.type === FIELD_TYPES.CHECKBOX ||
                ...
                field.type === FIELD_TYPES.SELECT) && (React.createElement("div", null,
                React.createElement("p", null,
                    React.createElement("strong", null, "Options:")),
                React.createElement("ul", null, field.options.map(function (option, i) { return (React.createElement("li", { key: i }, option)); })))),
            field.type === FIELD_TYPES.NUMBER && (React.createElement("p", null,
                React.createElement("strong", null, "Range:"),
                " ",
                field.minValue,
                " to ",
                field.maxValue)))); }))) : (React.createElement("div", { style: { textAlign: 'center', padding: '20px', background: '#f5f5f5', borderRadius: '4px' } }, "No fields added yet. Click \"Add Form Field\" to start building your form.")),
        renderFieldModal()));
};
