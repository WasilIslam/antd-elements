...
import { Input, Space, Button, Select, Form, Card, Tooltip, InputNumber, Radio, Checkbox, Modal, Row, Col, Switch } from 'antd';
...
var TextAreaWithSaveCancel = function (_a) {
    ...
    return (React__default.createElement("div", { style: { marginTop: 10 } },
        React__default.createElement(TextArea$1, { value: value, onChange: handleChange, rows: 4, placeholder: "Type something...", style: { width: "100%" } }),
        isUpdated && (React__default.createElement(Space, { style: { display: "flex", justifyContent: "flex-end", marginTop: 5 } },
            React__default.createElement(Button, { type: "primary", onClick: handleSave }, "Save"),
            React__default.createElement(Button, { onClick: handleCancel }, "Cancel")))));
};
...
var RefIcon$5 = /*#__PURE__*/React.forwardRef(ArrowDownOutlined);
if (process.env.NODE_ENV !== 'production') {
  RefIcon$5.displayName = 'ArrowDownOutlined';
}
...
var RefIcon$4 = /*#__PURE__*/React.forwardRef(ArrowUpOutlined);
if (process.env.NODE_ENV !== 'production') {
  RefIcon$4.displayName = 'ArrowUpOutlined';
}
...
var RefIcon$3 = /*#__PURE__*/React.forwardRef(DeleteOutlined);
if (process.env.NODE_ENV !== 'production') {
  RefIcon$3.displayName = 'DeleteOutlined';
}
...
var RefIcon$2 = /*#__PURE__*/React.forwardRef(EditOutlined);
if (process.env.NODE_ENV !== 'production') {
...
var RefIcon$1 = /*#__PURE__*/React.forwardRef(EyeOutlined);
if (process.env.NODE_ENV !== 'production') {
  RefIcon$1.displayName = 'EyeOutlined';
}
...
var getInitialField = function () { return ({
    id: v4(),
...
var AntdElementsForm = function (_a) {
    ...
    var _f = useState(getInitialField()), currentField = _f[0], setCurrentField = _f[1];
    ...
    var handleAddField = function () {
        form.validateFields().then(function (values) {
            var newField = __assign(__assign({}, currentField), values);
            if (isEditing) {
                var updatedFields = fields.map(function (field) {
                    return field.id === newField.id ? newField : field;
                });
                updateFields(updatedFields);
            }
            else {
                updateFields(__spreadArray(__spreadArray([], fields, true), [newField], false));
            }
    ...
    // Delete a field
    var handleDeleteField = function (id) {
        var updatedFields = fields.filter(function (field) { return field.id !== id; });
        updateFields(updatedFields);
    };
    // Edit a field
    ...
    var handleMoveUp = function (index) {
        ...
        if (index === 0)
            return;
        var newFields = __spreadArray([], fields, true);
        _a = [newFields[index - 1], newFields[index]], newFields[index] = _a[0], newFields[index - 1] = _a[1];
    ...
    var handleOptionChange = function (options) {
        setCurrentField(__assign(__assign({}, currentField), { options: options }));
    };
    // Add a new option
    var handleAddOption = function () {
        var options = __spreadArray(__spreadArray([], currentField.options, true), ["Option ".concat(currentField.options.length + 1)], false);
        handleOptionChange(options);
    };
    // Remove an option
    var handleRemoveOption = function (index) {
        var options = currentField.options.filter(function (_, i) { return i !== index; });
        handleOptionChange(options);
    };
    // Handle option text change
    var handleOptionTextChange = function (index, value) {
        var options = __spreadArray([], currentField.options, true);
        options[index] = value;
        handleOptionChange(options);
    };
    // Handle preview form submission
    var handlePreviewSubmit = function (values) {
        if (onSubmitPreview) {
            onSubmitPreview(values);
        }
    };
    // Render field in preview mode
    var renderPreviewField = function (field) {
        var type = field.type, label = field.label, placeholder = field.placeholder, required = field.required, instructions = field.instructions, options = field.options, minValue = field.minValue, maxValue = field.maxValue;
        var formItemProps = {
            label: label,
            name: field.id,
            required: required,
    ...
    var renderFieldModal = function () { return (React__default.createElement(Modal, { title: isEditing ? "Edit Field" : "Add Field", open: isModalVisible, onOk: handleAddField, onCancel: function () {
            setIsModalVisible(false);
            setCurrentField(getInitialField());
            form.resetFields();
            setIsEditing(false);
        }, width: 700 },
        React__default.createElement(Form, { form: form, layout: "vertical", initialValues: currentField },
            React__default.createElement(Row, { gutter: 16 },
                React__default.createElement(Col, { span: 12 },
                    React__default.createElement(Form.Item, { name: "type", label: "Field Type", rules: [{ required: true, message: 'Please select a field type' }] },
                        React__default.createElement(Select, { onChange: function (value) { return setCurrentField(__assign(__assign({}, currentField), { type: value })); } },
                            React__default.createElement(Option, { value: FIELD_TYPES.INPUT }, "Text Input"),
                            React__default.createElement(Option, { value: FIELD_TYPES.TEXTAREA }, "Text Area"),
                            React__default.createElement(Option, { value: FIELD_TYPES.CHECKBOX }, "Multiple Choice (Checkbox)"),
                            React__default.createElement(Option, { value: FIELD_TYPES.RADIO }, "Radio Buttons"),
                            React__default.createElement(Option, { value: FIELD_TYPES.NUMBER }, "Number"),
                            React__default.createElement(Option, { value: FIELD_TYPES.SELECT }, "Dropdown Select")))),
                React__default.createElement(Col, { span: 12 },
                    React__default.createElement(Form.Item, { name: "label", label: "Field Label", rules: [{ required: true, message: 'Please enter a label' }] },
                        React__default.createElement(Input, { placeholder: "Enter field label" })))),
            React__default.createElement(Form.Item, { name: "placeholder", label: "Placeholder" },
                React__default.createElement(Input, { placeholder: "Enter placeholder text" })),
            React__default.createElement(Form.Item, { name: "instructions", label: "Instructions" },
                React__default.createElement(Input, { placeholder: "Enter instructions for this field" })),
            React__default.createElement(Form.Item, { name: "required", valuePropName: "checked" },
                React__default.createElement(Switch, { checkedChildren: "Required", unCheckedChildren: "Optional" })),
            (currentField.type === FIELD_TYPES.NUMBER) && (React__default.createElement(Row, { gutter: 16 },
                React__default.createElement(Col, { span: 12 },
                    React__default.createElement(Form.Item, { name: "minValue", label: "Minimum Value" },
                        React__default.createElement(InputNumber, null))),
                React__default.createElement(Col, { span: 12 },
                    React__default.createElement(Form.Item, { name: "maxValue", label: "Maximum Value" },
                        React__default.createElement(InputNumber, null))))),
            (currentField.type === FIELD_TYPES.CHECKBOX ||
                currentField.type === FIELD_TYPES.RADIO ||
                currentField.type === FIELD_TYPES.SELECT) && (React__default.createElement("div", null,
                React__default.createElement("div", { className: "options-header", style: { display: 'flex', justifyContent: 'space-between', marginBottom: '10px' } },
                    React__default.createElement("h4", null, "Options"),
                    React__default.createElement(Button, { type: "dashed", onClick: handleAddOption, icon: React__default.createElement(RefIcon, null) }, "Add Option")),
                currentField.options.map(function (option, index) { return (React__default.createElement("div", { key: index, style: { display: 'flex', marginBottom: '8px' } },
    ...
    return (React__default.createElement("div", null,
        ...
        fields.length > 0 ? (React__default.createElement("div", null, fields.map(function (field, index) { return (React__default.createElement(Card, { key: field.id, style: { marginBottom: 16 }, title: "".concat(index + 1, ". ").concat(field.label, " (").concat(field.type, ")"), extra: React__default.createElement(Space, null,
                ...
                React__default.createElement(Tooltip, { title: "Move Down" },
                    React__default.createElement(Button, { icon: React__default.createElement(RefIcon$5, null), disabled: index === fields.length - 1, onClick: function () { return handleMoveDown(index); } })),
                React__default.createElement(Tooltip, { title: "Edit" },
                    React__default.createElement(Button, { icon: React__default.createElement(RefIcon$2, null), onClick: function () { return handleEditField(field); } })),
                React__default.createElement(Tooltip, { title: "Delete" },
                    React__default.createElement(Button, { danger: true, icon: React__default.createElement(RefIcon$3, null), onClick: function () { return handleDeleteField(field.id); } }))) },
            React__default.createElement("p", null,
                React__default.createElement("strong", null, "Type:"),
                " ",
                field.type),
            field.placeholder && React__default.createElement("p", null,
                React__default.createElement("strong", null, "Placeholder:"),
                " ",
                field.placeholder),
            field.instructions && React__default.createElement("p", null,
                React__default.createElement("strong", null, "Instructions:"),
                " ",
                field.instructions),
            React__default.createElement("p", null,
                React__default.createElement("strong", null, "Required:"),
                " ",
                field.required ? 'Yes' : 'No'),
            (field.type === FIELD_TYPES.CHECKBOX ||
                field.type === FIELD_TYPES.RADIO ||
                field.type === FIELD_TYPES.SELECT) && (React__default.createElement("div", null,
                React__default.createElement("p", null,
                    React__default.createElement("strong", null, "Options:")),
                React__default.createElement("ul", null, field.options.map(function (option, i) { return (React__default.createElement("li", { key: i }, option)); })))),
            field.type === FIELD_TYPES.NUMBER && (React__default.createElement("p", null,
                React__default.createElement("strong", null, "Range:"),
                " ",
                field.minValue,
                " to ",
                field.maxValue)))); }))) : (React__default.createElement("div", { style: { textAlign: 'center', padding: '20px', background: '#f5f5f5', borderRadius: '4px' } }, "No fields added yet. Click \"Add Form Field\" to start building your form.")),
        renderFieldModal()));
};
